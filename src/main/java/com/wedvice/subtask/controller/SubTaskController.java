...
//    회원의 모든 coupletask의 subtask를 조회하여 금액을 계산한다. (전체 금액 확인)
    ...
    @PatchMapping("/align")
    public String patchAlign(@LoginUser CustomUserDetails loginUser,
        @RequestBody SubTaskAlignRequestDTO requestDTO) {
    ...
    @PostMapping()
    public String post(@LoginUser CustomUserDetails loginUser,
    ...
    public String subTaskCompleted(@LoginUser CustomUserDetails loginUser,
